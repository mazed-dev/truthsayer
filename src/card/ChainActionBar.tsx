...
import NextNewRightImg from './../img/next-link-right-00001.svg'
import NextNewLeftImg from './../img/next-link-left-00001.svg'
import SearchImg from './../img/search.svg'
import { UploadNodeButton } from '../upload/UploadNodeButton'
import NextCopyLeftImg from './../img/next-clone-left.svg'
import NextCopyRightImg from './../img/next-clone-right.svg'
