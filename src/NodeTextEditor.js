...
import {Card, Badge, Button, ButtonToolbar, ButtonGroup, InputGroup, FormControl, Container, Row, Col, CardColumns, DropdownButton, Dropdown, OverlayTrigger, Tooltip} from 'react-bootstrap';

      // <Card style={{ width: '25rem' }}>
          // <Badge className="meta-fluid-element" variant="success"> New </Badge>
class RefNodeCard extends React.Component {
  ...
  render() {
    var toolbar;
    const title_el = (
      <Button variant="outline-danger" size="sm">{this.state.title}</Button>
    );
    if (this.props.offer) {
      toolbar = (
        <ButtonGroup>
      ...
      if (this.state.hover) {
        toolbar = (
          ...
          <ButtonGroup>
            ...
            <Button variant="secondary" size="sm">&#9988;</Button>
            <DropdownButton as={ButtonGroup} title="&hellip;" id="bg-vertical-dropdown-1" variant="secondary" size="sm">
    ...
    return (
      <Card className="rounded" onMouseEnter={this.toggleHover} onMouseLeave={this.toggleHover}>
        <div className="meta-fluid-element">
          {toolbar}
        </div>
  ...
  render() {
    return (
      <ButtonGroup vertical>
        ...
        <DropdownButton as={ButtonGroup} title="H2" id="bg-vertical-dropdown-1" variant="light">
          <Dropdown.Item eventKey="1">H1</Dropdown.Item>
          <Dropdown.Item eventKey="2">H2</Dropdown.Item>
          <Dropdown.Item eventKey="3">H3</Dropdown.Item>
        </DropdownButton>
