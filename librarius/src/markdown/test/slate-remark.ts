...
describe('Array', () => {
  describe('#indexOf()', () => {
    // it('Markdown to Slate state - headers', () => {
    //   const md = `
    // # Header 1
    // ## Header 2
    // ### Header 3
    ...
    // })
    //
    // it('Markdown to Slate state - Bold', () => {
    //   const md = `
    // **Trees were swaying**
    // `
    //   const value = markdownToSlate(md)
    ...
    // })
    //
    // it('Markdown to Slate state - Thematic break', () => {
    //   const md = `
    // Text before
    //
    // ---
    ...
    // })
    //
    // it('Markdown to Slate state - Italic && Bold', () => {
    //   const md = `
    ...
    // })
    //
    // it('Markdown to Slate state - Code Block', () => {
    //   const md = `
    // \`\`\`python
    ...
    // })
    //
    // it('Markdown to Slate state - Table (not supported by Mazed yet)', () => {
    ...
    // })
    //
    // it('Markdown to Slate state - Blockquote', () => {
    //   const md = `
    ...
    // })
    //
    // it('Markdown to Slate state - Checklist', () => {
    //   const md = `
    ...
    // })
    //
    // it('Markdown to Slate state - Ordered list', () => {
    //   const md = `
    // 1. Though gently
    ...
    // })
    //
    // it('Markdown to Slate state - MD native image', () => {
    //   const md = `
    ...
    // })
    //
    // it('Markdown to Slate state - inline code', () => {
    ...
    // })
    //
    // it('Extra(list hack): from md and back', () => {
...
-----`
      ...
      assert.equal(plaintext, 'Header 1')
